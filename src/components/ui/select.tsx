...
import  Checkfrom from 'lucide-react';
...
>(({ className, children, ...props }, ref) => (
    <SelectPrimitive.Trigger
        ref={ref}
        className={cn(
            'flex h-10 w-full items-center justify-between rounded-md border border-gray-200 border-gray-200 bg-transparent px-3 py-2 text-sm ring-offset-bluePrimary placeholder:text-gray-500 focus:outline-none focus:ring-0  focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50 dark:border-gray-800 dark:border-gray-800 dark:ring-offset-gray-950 dark:placeholder:text-gray-400 dark:focus:ring-gray-800',
            className
        )}
        {...props}
    >
